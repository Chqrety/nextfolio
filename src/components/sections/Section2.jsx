    ...
    <section id="about" className="min-h-[70vh]">
      ...
      <div className="flex justify-center">
        <div className="flex w-1/2 flex-col items-center justify-center text-center">
          ...
          <p className="italic">
            Hello semuanya, Aku Averus, seorang developer yang berdedikasi untuk menciptakan solusi digital yang
            inovatif. memiliki pengalaman pada bidang web development membuat saya memiliki skill untuk mengembangkan
            aplikasi web yang responsif dan user-friendly. dan siap berkolaborasi dengan siapa saja
          </p>
        </div>
      </div>
    </section>
